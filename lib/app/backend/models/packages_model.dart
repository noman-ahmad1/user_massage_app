...
class PackagesModel {
  ...
  PackagesModel({this.id, this.uid, this.packageFrom, this.name, this.cover, this.serviceId, this.descriptions, this.images, this.duration, this.price, this.off, this.discount, this.specialistIds, this.extraField, this.status});
