              ...
              child: Column(
                ...
                children: [
                  ...
                  Column(
                    ...
                    mainAxisAlignment: MainAxisAlignment.start,
                    children: [
                      salonOrderInfo.orders!.isNotEmpty ? Text('Products'.tr, overflow: TextOverflow.ellipsis, style: const TextStyle(color: ThemeProvider.appColor, fontFamily: 'bold', fontSize: 15)) : const SizedBox(),
                      const SizedBox(height: 10),
                      Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        mainAxisAlignment: MainAxisAlignment.start,
