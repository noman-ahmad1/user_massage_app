...
class EditProfileController extends GetxController implements GetxService {
  ...
  Future<void> onUpdateInfo() async {
    ...
    var body = {"id": parser.getUID(), "first_name": firstNameTextEditor.text, "last_name": lastNameTextEditor.text, "gender": selectedGender, "cover": cover, "country_code": countryCodeMobile, "mobile": mobileTextEditor.text};
