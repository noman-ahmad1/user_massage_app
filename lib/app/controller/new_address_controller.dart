...
class NewAddressController extends GetxController implements GetxService {
  ...
  void getLatLngFromAddress() async {
    ...
    var response = await parser
        .getLatLngFromAddress('https://maps.googleapis.com/maps/api/geocode/json?address=${addressTextEditor.text} ${houseTextEditor.text} ${landmarkTextEditor.text}${pincodeTextEditor.text}&key=${Environments.googleMapsKey}');
  ...
  Future<void> updateAddress() async {
    var body = {"title": title, "address": addressTextEditor.text, "house": houseTextEditor.text, "landmark": landmarkTextEditor.text, "pincode": pincodeTextEditor.text, "lat": lat, "lng": lng, "id": addressId};
